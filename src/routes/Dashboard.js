                      ...
                      <div className="tp-banner" >
                        <ul> 
                          <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                            <img src="/imgs/app/homepage/background.png"  alt="slidebg1"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat" />
                            ...
                            <div className="tp-caption customin customout"
                              ...
                              data-endspeed="500"
                              data-endeasing="Power4.easeIn"
                              style={{zIndex: '3'}}><img src="/imgs/app/homepage/simplepowerful.png" alt=""/>
                            </div>            
                          </li>


                          <li data-transition="zoomout" data-slotamount="7" data-masterspeed="1000" >
                            <img src="/imgs/app/homepage/simplepowerful.png"  alt=""  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat" />
                            <div className="tp-caption customin fullscreenvideo"
                              data-x="0"
                              data-y="0"
                              ...
                              style={{zIndex: '2'}}><iframe src='http://player.vimeo.com/video/76995667?title=0&byline=0&portrait=0;api=1' width='100%' height='100%' style={{width:'100%px',height:'100%px'}}></iframe>
                            </div>
                          </li>
                        </ul>
